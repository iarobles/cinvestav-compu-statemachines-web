	...
	<div class="fieldset-content">
		...
		<div class="form-row">
			...
			<div class="form-col-right">
				<form:input path="alphabetLength" disabled="true" id="alphabetLength" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="form-row">
			...
			<div class="form-col-right">
				<form:input path="alphabetAsString" disabled="true" id="alphabetAsString"></form:input>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="form-row">
			...
			<div class="form-col-right">
				<form:input path="totalStates" disabled="true" id="totalStates" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="form-row">
			...
			<div class="form-col-right">
				<form:textarea disabled="true" path="statesAsString" id="statesAsString" cssClass="textarea-states"/>
			</div>
			<div class="clear"></div>
		</div>
				...
				<c:forEach var="state" items="${dfaEq.states}"
					...
					<tr>
						...
						<c:forEach var="symbol" items="${dfaEq.alphabet}"
							...
							<c:set var="stateIndex" value="${dfaEqTransitionMatrix[stateStatus.index][symbolStatus.index]}" />
...
<div class="fieldset-box ui-widget-content background-erase">
	...
	<div class="fieldset-content">
		...
		<div class="form-row">
			<c:choose>
				<c:when test="${dfaEq.isAcceptable !=null and dfaEq.isAcceptable==true}">
				...
				<c:when test="${dfaEq.isAcceptable !=null and dfaEq.isAcceptable==false}">
					<div class="ui-state-error ui-corner-all form-row text-center">
						<p>
